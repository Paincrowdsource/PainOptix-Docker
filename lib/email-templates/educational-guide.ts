  ...
  const html = `
    ...
    <body>
      ...
      <div class="tier-box">
        ...
        <p>Access a physician-written guide by Bradley W. Carpentier, MD, detailing ${guideName.toLowerCase()} causes, red flags, treatments (e.g., exercises with ${content.successRate} success rate []), imaging advice, and a 14-day tracker. Includes free PainCrowdsource.org access to learn from others.</p>
        <div style="text-align: center;">
      ...
      <div class="tier-box" style="border-color: #2563eb;">
        ...
        <p>Book a one-on-one video call with Bradley W. Carpentier, MD to confirm your ${guideName.toLowerCase()} pattern, customize your recovery plan, and address urgent concerns. Limited spots!</p>
        <div style="text-align: center;">
      ...
      <div style="background-color: #f3f4f6; padding: 20px; border-radius: 8px; margin: 20px 0;">
        <p style="margin: 0 0 10px 0; font-weight: bold;">Didn't purchase? You can upgrade anytime!</p>
        <p style="margin: 0;">Access your personalized relief strategies and expert guidance.</p>
        <a href="${guideUrl}/upgrade" style="display: inline-block; margin-top: 10px; color: #2563eb; text-decoration: underline;">View upgrade options →</a>
      </div>
...
Access a physician-written guide by Bradley W. Carpentier, MD with ${content.successRate} success rate.
Unlock My Monograph: ${guideUrl}/upgrade?tier=monograph

$250 TELEHEALTH CONSULT
Book a one-on-one video call with Bradley W. Carpentier, MD. Limited spots!
...
----------------------------------------
Didn't purchase? You can upgrade anytime!
View upgrade options: ${guideUrl}/upgrade
----------------------------------------
...
export function getSMSTemplate(params: GuideTemplateParams) {
  ...
  return `PainFinder™: Your ${guideName} guide is ready! View it here: ${guideUrl} SPECIAL: Get enhanced report for $5 (was $7). Upgrade now for personalized relief plan. Reply STOP to unsubscribe.`
}