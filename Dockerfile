...
ARG NEXT_PUBLIC_DISABLE_PAYMENTS
ARG NEXT_PUBLIC_VALUE_FIRST_FUNNEL
...
ENV NEXT_PUBLIC_DISABLE_PAYMENTS=$NEXT_PUBLIC_DISABLE_PAYMENTS
ENV NEXT_PUBLIC_VALUE_FIRST_FUNNEL=$NEXT_PUBLIC_VALUE_FIRST_FUNNEL
